...
class App:
    def __init__(self, username='7893215413', password='Ranga@123$', target_username='dataminer2060',
                 path='C:\\Users\\rkamepax\Desktop\\web-scraping\\Instagram_scraper\\photos'): #Change this to your Instagram details and desired images path
        self.username = username
        self.password = password
        self.target_username = target_username
        self.path = path
        self.driver = webdriver.Chrome('C:\\Users\\rkamepax\\Desktop\\web-scraping\\selenium\\chromedriver.exe') #Change this to your ChromeDriver path.
        self.error = False
